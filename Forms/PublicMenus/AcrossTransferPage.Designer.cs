namespace Corvus.Forms.MemberMenus
{
    partial class AcrossTransferPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            // textBalance
            // 
            textBalance.Location = new Point(46, 139);
            textBalance.Margin = new Padding(6);
            ...
            // textBenef
            // 
            textBenef.Location = new Point(46, 256);
            textBenef.Margin = new Padding(6);
            ...
            // textAmount
            // 
            textAmount.Location = new Point(46, 371);
            ...
            label3.Location = new Point(43, 326);
            ...
            // textTransRef
            // 
            textTransRef.Location = new Point(46, 489);
            textTransRef.Margin = new Padding(6);
            ...
            label4.Location = new Point(43, 444);
            ...
            // textRemarks
            // 
            textRemarks.Location = new Point(46, 608);
            textRemarks.Margin = new Padding(6);
            ...
            label5.Location = new Point(43, 561);
            ...
            buttonSubmit.Location = new Point(43, 732);
            ...
            buttonClear.Location = new Point(254, 732);
            ...
            dgvIncoming.BackgroundColor = Color.Purple;
            dgvIncoming.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvIncoming.Location = new Point(494, 68);
            dgvIncoming.Margin = new Padding(6);
            ...
            label6.Location = new Point(494, 30);
            ...
            label7.Location = new Point(494, 420);
            ...
            dgvOutgoing.BackgroundColor = Color.Purple;
            dgvOutgoing.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvOutgoing.Location = new Point(494, 459);
            dgvOutgoing.Margin = new Padding(6);
            ...
            dgvOutgoing.CellContentClick += dgvOutgoing_CellContentClick;
            // 
            // labelMyBenef
            // 
            labelMyBenef.AutoSize = true;
            labelMyBenef.BackColor = Color.FromArgb(64, 0, 64);
            labelMyBenef.Font = new Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            labelMyBenef.ForeColor = Color.White;
            labelMyBenef.Location = new Point(43, 30);
