...
namespace Corvus.Forms
{
    public partial class AccrossPage : UserControl
    {
        ...
        private async void LoadData()
        {
            ...
            BalanceApiResponse? balanceApiResponse = await connectorGet.GetBalancesByCoopAsync(configuration.terminolog3);
            if (balanceApiResponse != null && balanceApiResponse.ResponseCode == "00")
            {
                ...
                {
                    dgvMember.Rows.Add(balance.Member.Code, balance.Member.Name, balance.Amount);
                }
            }
            else
            {
            ...
            TransferApiResponse? transferApiResponse = await connectorGet.GetTransfersByCoopAsync(configuration.terminolog3);
